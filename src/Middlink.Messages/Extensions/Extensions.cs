...
namespace Middlink.Messages.Extensions
{
    public static class Extensions
    {
        ...
        public static T BindId<T>(this T model, Expression<Func<T, Guid>> expression) => model.Bind<T, Guid>(expression, Guid.NewGuid());
